...
public class J207_37 extends Application {
    ...
    //* Part 7: Tricky!
    //* The media URLs each have a different number in the URL.
    //* I needed to pick the correct numbers to play the correct anthem for each flag.
    private MediaPlayer[] anthems = new MediaPlayer[]{
            new MediaPlayer(new Media("https://liveexample.pearsoncmg.com/common/audio/anthem/anthem6.mp3")),
            new MediaPlayer(new Media("https://liveexample.pearsoncmg.com/common/audio/anthem/anthem3.mp3")),
            new MediaPlayer(new Media("https://liveexample.pearsoncmg.com/common/audio/anthem/anthem5.mp3")),
    ...
    public void setDisplay(int index) {
        ...
        //* Part 7:
        for (int i = 0; i < anthems.length; i++) {
            if (i == index) {
                anthems[i].play();
            } else {
                anthems[i].stop();
